...
class CommandResourceIT {
    ...
    public static Command createEntity(EntityManager em) {
        Command command = new Command().state(DEFAULT_STATE).purchaseDate(DEFAULT_PURCHASE_DATE);
        return command;
    }
    ...
    public static Command createUpdatedEntity(EntityManager em) {
        Command command = new Command().state(UPDATED_STATE).purchaseDate(UPDATED_PURCHASE_DATE);
        return command;
    }
...
//    }
    ...
    void putExistingCommand() throws Exception {
        ...
        updatedCommand.state(UPDATED_STATE).purchaseDate(UPDATED_PURCHASE_DATE);
    ...
    void partialUpdateCommandWithPatch() throws Exception {
        ...
        partialUpdatedCommand.state(UPDATED_STATE).purchaseDate(UPDATED_PURCHASE_DATE);
